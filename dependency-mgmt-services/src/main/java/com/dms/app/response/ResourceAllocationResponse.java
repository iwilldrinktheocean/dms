 ...
 *
 */
public class ResourceAllocationResponse extends BaseResponse {
	...
	/**
	 * @param noOfUtilizedFTEs
	 *            the noOfUtilizedFTEs to set
	 */
	...
	/**
	 * @param budgetAvailable
	 *            the budgetAvailable to set
	 */
